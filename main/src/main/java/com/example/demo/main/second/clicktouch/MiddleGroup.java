...
public class MiddleGroup extends RelativeLayout {
    @InterceptType
    ...
    public MiddleGroup(Context context) {
        super(context);
    }

    public MiddleGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MiddleGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public MiddleGroup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        if (mOnTouchEventListener != null) {
            mOnTouchEventListener.touchResult(OnTouchEventListener.TouchEventFrom.FROM_MIDDLE,
